...
import { ArrowRight, LogOut, Settings, Upload } from 'lucide-react'
    ...
    <AppShell>
      <main className="min-h-screen bg-[#f7f9fc] text-[#08111f]">
        <header className="sticky top-0 z-40 border-b border-[#dbe2ec] bg-white/95 backdrop-blur-xl">
          <div className="mx-auto flex h-[72px] max-w-[1480px] items-center justify-end gap-2 px-5 pl-20 sm:px-8 sm:pl-24">
